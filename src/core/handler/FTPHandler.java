...
import java.io.IOException;
	...
	public class FTPHandler {
	    ...
	    **/
	    private Logger log = Logger.getLogger(FTPHandler.class);
	 ...
	 * Constructor - Creates FTP for given host data
	     ...
	     * @param ftpPwd
	 ******************************************************************************/
	    public FTPHandler(String ftpHost, String ftpUser, String ftpPwd) {
	        ...
	        **/
	        ...
	        try {
	            ...
	            java.util.logging.Logger.getLogger(FTPHandler.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	        }
	        //this.connect();
	    }
