...
public class MainView3 extends JFrame {
	...
	public MainView3() {
		setResizable(false);
		setIconImage(Toolkit.getDefaultToolkit().getImage(MainView3.class.getResource("/res/favicon/dromedar.png")));
	...
	public void compCreate() {
		...
		btnNewButton.setRolloverIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_search_highlighted.png")));
		btnNewButton.setFocusPainted(false);
		btnNewButton.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_search.png")));
		...
		btnNewButton.setForeground(new Color(255, 255, 255));
		{
			...
			mnSearchsettings.setPressedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_searchSettingsHighlighted.png")));
			mnSearchsettings.setRolloverSelectedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_searchSettingsHighlighted.png")));
			mnSearchsettings.setSelectedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_searchSettingsHighlighted.png")));
			mnSearchsettings.setRolloverIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_searchSettingsHighlighted.png")));
			mnSearchsettings.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_searchSettings.png")));
			menuBar.add(mnSearchsettings);
			{
				JRadioButtonMenuItem rdbtnmntmShowGrparticle = new JRadioButtonMenuItem("Find GrpArticle");
				rdbtnmntmShowGrparticle.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_findGrpArticle.png")));
			...
			}
			{
				...
				rdbtnmntmShowSingleArticles.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_searchAll.png")));
		...
		mnSettigns.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_boards.png")));
		mnSettigns.setBorder(null);
		mnSettigns.setFont(new Font("Open Sans", Font.BOLD, 18));
		menuBar.add(mnSettigns);
		{
			rdbtnmntm_adminpanelBrands = new JRadioButtonMenuItem("Brands (Logos)");
			...
			rdbtnmntm_adminpanelBrands.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_boardBrands.png")));
			mnSettigns.add(rdbtnmntm_adminpanelBrands);
		}
		{
			rdbtnmntm_adminpanelArticles = new JRadioButtonMenuItem("Articles (Images)");
			rdbtnmntm_adminpanelArticles.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_boardArticles.png")));
			rdbtnmntm_adminpanelArticles.setSelected(true);
			mnSettigns.add(rdbtnmntm_adminpanelArticles);
		}
		{
			JRadioButtonMenuItem rdbtnmntmMedia = new JRadioButtonMenuItem("Other Media");
			rdbtnmntmMedia.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_boardMedia.png")));
		...
		mnTools.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_tools.png")));
		...
		mntm_imageWizard.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_imgWzrd.png")));
		...
		mnMedia.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_media.png")));
		...
		mnUserprofile.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_user.png")));
		...
		}
		{
			...
			mntmLogout.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_authority.png")));
		...
		mnInfo.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_info.png")));
		...
		}
		{
			...
			mnSystem.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_system.png")));
			mnSystem.setBorder(null);
			mnSystem.setFont(new Font("Open Sans", Font.BOLD, 18));
			menuBar.add(mnSystem);
			{
				JMenuItem mntmStores = new JMenuItem("Settings");
				mntmStores.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_settings.png")));
				mnSystem.add(mntmStores);
			}
			{
				JMenu mnRemoteConfig = new JMenu("User Management");
				mnRemoteConfig.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_userManagement.png")));
				mnSystem.add(mnRemoteConfig);
				{
					JMenuItem mntmUsers = new JMenuItem("Users");
					mntmUsers.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_users.png")));
					mnRemoteConfig.add(mntmUsers);
				}
				{
					JMenuItem mntmUserroles = new JMenuItem("UserRoles");
					mntmUserroles.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_userRoles.png")));
			...
			}
			{
				...
				mntmExit.setPressedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_shutDown_highlighted.png")));
				mntmExit.setRolloverIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_shutDown_highlighted.png")));
				mntmExit.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_shutDown.png")));
		...
		pnl_contentWrap.setLayout(new CardLayout(0, 0));
		{
			...
			pnl_articlesBoard.setLayout(null);
			{
				...
				panel.setBounds(10, 11, 302, 663);
				pnl_articlesBoard.add(panel);
				panel.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
				panel.setBackground(new Color(153, 204, 204));
				panel.setLayout(null);
				{
					JScrollPane scrollPane = new JScrollPane();
					scrollPane.setBounds(10, 53, 282, 528);
				...
				}
				{
					...
					panel_1.setBounds(10, 592, 282, 60);
					panel.add(panel_1);
					panel_1.setLayout(null);
					{
						JButton button = new JButton("");
						button.setBorder(new LineBorder(new Color(255, 255, 255), 2));
						button.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_goToWebProductView_enabled.png")));
						button.setDisabledIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_goToWebProductView_disabled.png")));
				...
				}
				{
					...
					toggleButton.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_findGrpArticle.png")));
				...
				}
				{
					...
					toggleButton.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@menu_searchAll.png")));
					toggleButton.setBorder(new LineBorder(new Color(0, 0, 0)));
			...
			pnl_treeNodeDetails.setLayout(null);
			{
				...
				tabbedPane_articleMedia.setBorder(new CompoundBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null), new EmptyBorder(2, 2, 2, 2)));
				...
				tabbedPane_articleMedia.setBounds(10, 11, 862, 641);
				...
				tabbedPane_articleMedia.addTab("", new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_images.png")), pnl_articleImages, "");
				tabbedPane_articleMedia.setDisabledIconAt(0, new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@tab_images_disabled.png")));
				...
				pnl_articleImages.setLayout(null);
				{
					...
					lbl_ArticleImageViewport.setBorder(new LineBorder(new Color(153, 153, 153)));
					lbl_ArticleImageViewport.setHorizontalAlignment(SwingConstants.CENTER);
					lbl_ArticleImageViewport.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_imageViewportPlaceholder.png")));
					lbl_ArticleImageViewport.setBounds(199, 70, 379, 379);
					pnl_articleImages.add(lbl_ArticleImageViewport);
				}
				{
					JScrollPane scrollPane = new JScrollPane();
					scrollPane.setBounds(10, 11, 156, 482);
				...
				}
				{
					...
					panel_1.setBounds(614, 11, 217, 482);
					pnl_articleImages.add(panel_1);
					panel_1.setLayout(null);
					{
						JButton btn_imgFileAdd = new JButton("");
						btn_imgFileAdd.setPressedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileAdd_pressed.png")));
						btn_imgFileAdd.setRolloverSelectedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileAdd_highlighted.png")));
						btn_imgFileAdd.setRolloverIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileAdd_highlighted.png")));
						btn_imgFileAdd.addMouseListener(new MouseAdapter() {
							@Override
						...
						btn_imgFileAdd.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileAdd.png")));
					}
					{
						JButton button = new JButton("");
						button.setPressedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileExchange_pressed.png")));
						button.setRolloverIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileExchange_highlighted.png")));
						button.setRolloverSelectedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileExchange_highlighted.png")));
						button.setBounds(62, 11, 42, 42);
						panel_1.add(button);
						button.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileExchange.png")));
						button.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
					}
					{
						JButton button = new JButton("");
						button.setPressedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileDownload_pressed.png")));
						button.setRolloverSelectedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileDownload_highlighted.png")));
						button.setRolloverIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileDownload_highlighted.png")));
						button.setBounds(10, 64, 42, 42);
						panel_1.add(button);
						button.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileDownload.png")));
						button.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
					}
					{
						JButton button = new JButton("");
						button.setPressedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileDelete_pressed.png")));
						button.setRolloverSelectedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileDelete_highlighted.png")));
						button.setRolloverIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileDelete_highlighted.png")));
						button.setBounds(114, 11, 42, 42);
						panel_1.add(button);
						button.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileDelete.png")));
						button.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
					}
					{
						JToggleButton toggleButton = new JToggleButton("");
						...
						toggleButton.setSelected(true);
						toggleButton.setSelectedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_mediaEnabledSelected.png")));
						toggleButton.setContentAreaFilled(false);
						toggleButton.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_mediaEnabledNonSelected.png")));
					}
					{
						JToggleButton toggleButton = new JToggleButton("");
						...
						btnGrp_mediaImgStatus.add(toggleButton);
						toggleButton.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
						toggleButton.setSelectedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_mediaDisabledSelected.png")));
						toggleButton.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_mediaDisabledNonSelected.png")));
						toggleButton.setContentAreaFilled(false);
					}
					{
						JSeparator separator = new JSeparator();
					...
					{
						JButton button = new JButton("");
						button.setPressedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileSettings_pressed.png")));
						button.setRolloverIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileSettings_highlighted.png")));
						button.setRolloverSelectedIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileSettings_highlighted.png")));
						button.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@btn_fileSettings.png")));
						button.setBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null));
						button.setBounds(62, 64, 42, 42);
						panel_1.add(button);
					}
					{
				...
				}
				{
					...
					lbl_titleBarArtNr.setBounds(199, 11, 67, 33);
					pnl_articleImages.add(lbl_titleBarArtNr);
					lbl_titleBarArtNr.setOpaque(true);
					lbl_titleBarArtNr.setBackground(new Color(255, 255, 204));
					lbl_titleBarArtNr.setBorder(new CompoundBorder(new LineBorder(new Color(102, 102, 102)), new EmptyBorder(0, 4, 0, 0)));
					lbl_titleBarArtNr.setFont(new Font("SansSerif", Font.BOLD, 14));
				}
				{
					lbl_titleBarArtName = new JLabel("Braunes Luxus-Toilettenpapier");
					lbl_titleBarArtName.setIconTextGap(20);
					lbl_titleBarArtName.setForeground(new Color(102, 102, 102));
					lbl_titleBarArtName.setBounds(265, 11, 313, 33);
					pnl_articleImages.add(lbl_titleBarArtName);
					lbl_titleBarArtName.setOpaque(true);
					lbl_titleBarArtName.setBorder(new CompoundBorder(new LineBorder(new Color(102, 102, 102)), new EmptyBorder(0, 4, 0, 0)));
					lbl_titleBarArtName.setFont(new Font("SansSerif", Font.BOLD, 14));
				}
				{
					JPanel panel = new JPanel();
					panel.setOpaque(false);
					panel.setBackground(new Color(255, 255, 255));
					panel.setBorder(new MatteBorder(0, 1, 1, 1, (Color) new Color(153, 153, 153)));
					panel.setBounds(199, 449, 379, 44);
					pnl_articleImages.add(panel);
				}
				{
					JPanel pnl_articleVideos = new JPanel();
					pnl_articleVideos.setBackground(new Color(255, 255, 255));
					tabbedPane_articleMedia.addTab("", new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_videos.png")), pnl_articleVideos, null);
					tabbedPane_articleMedia.setDisabledIconAt(1, new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@tab_videos_disabled.png")));
					pnl_articleVideos.setLayout(null);
					{
						JLabel lblNewLabel = new JLabel("");
						lblNewLabel.setOpaque(true);
						lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
						lblNewLabel.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_videoViewportPlaceholder.png")));
				...
				}
				{
					...
					tabbedPane_articleMedia.addTab("", new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_labels.png")), pnl_articleLabels, null);
					tabbedPane_articleMedia.setDisabledIconAt(2, new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@tab_labels_disabled.png")));
				...
				}
				{
					...
					tabbedPane_articleMedia.addTab("", new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_attachments.png")), pnl_articleAttachments, null);
					tabbedPane_articleMedia.setDisabledIconAt(3, new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon@tab_attachments_disabled.png")));
		...
		}
		{
			...
			pnl_brandsBoard.setLayout(null);
			{
				...
				}
				{
					...
					btn_addBrand.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_cycle-add.png")));
				...
				}
				{
					...
					btn_deleteBrand.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_cycle-remove.png")));
			...
			}
			{
				...
				pnl_brandsBoard.add(pnl_brandDetails);
				{
					...
					}
					{
						...
						btn_brandNameEdit.setIcon(new ImageIcon(MainView3.class.getResource("/res/icons/v2/icon_cycle-edit.png")));
